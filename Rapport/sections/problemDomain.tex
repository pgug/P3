...
The "Task" object gets created with a "Task created" function. The task can then be updated iterative. The task also have a "Task commented" function, that can add a "Task comment" object to the "Task" object. The task ends with the "Task completed" function or the "Task terminated" function.
